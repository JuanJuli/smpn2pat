						...
						<div class="col-lg-8 post-list">
							...
							<div class="popular-post-wrap">
								...
								<div class="feature-post relative">
									<div class="feature-img relative">
										<div class="overlay overlay-bg"></div>
										<img class="img-fluid" src="{{ asset('magazine/img/f1.jpg') }}" alt="">
									</div>
									<div class="details">
										<ul class="tags">
											<li><a href="#">Food Habit</a></li>
								...
								<div class="row mt-20 medium-gutters">
									<div class="col-lg-6 single-popular-post">
										<div class="feature-img-wrap relative">
											<div class="feature-img relative">
												<div class="overlay overlay-bg"></div>
												<img class="img-fluid" src="{{ asset('magazine/img/f2.jpg') }}" alt="">
											</div>
											<ul class="tags">
												<li><a href="#">Travel</a></li>
											</ul>
									...
									<div class="col-lg-6 single-popular-post">
										<div class="feature-img-wrap relative">
											<div class="feature-img relative">
												<div class="overlay overlay-bg"></div>
												<img class="img-fluid" src="{{ asset('magazine/img/f3.jpg') }}" alt="">
											</div>
											<ul class="tags">
												<li><a href="#">Travel</a></li>
											</ul>
								...
								<div class="relavent-story-list-wrap">
									<div class="single-relavent-post row align-items-center">
										<div class="col-lg-5 post-left">
											<div class="feature-img relative">
												<div class="overlay overlay-bg"></div>
												<img class="img-fluid" src="{{ asset('magazine/img/r1.jpg') }}" alt="">
											</div>
											<ul class="tags">
												<li><a href="#">Lifestyle</a></li>
											</ul>
									...
									<div class="single-relavent-post row align-items-center">
										<div class="col-lg-5 post-left">
											<div class="feature-img relative">
												<div class="overlay overlay-bg"></div>
												<img class="img-fluid" src="{{ asset('magazine/img/r2.jpg') }}" alt="">
											</div>
											<ul class="tags">
												<li><a href="#">Science</a></li>
											</ul>
									...
									<div class="single-relavent-post row align-items-center">
										<div class="col-lg-5 post-left">
											<div class="feature-img relative">
												<div class="overlay overlay-bg"></div>
												<img class="img-fluid" src="{{ asset('magazine/img/r3.jpg') }}" alt="">
											</div>
											<ul class="tags">
												<li><a href="#">Travel</a></li>
											</ul>
							...
							<div class="sidebars-area">
								<div class="single-sidebar-widget editors-pick-widget">
									...
									<div class="editors-pick-post">
										...
										<div class="post-lists">
											...
											<div class="single-post d-flex flex-row">
												<div class="thumb">
													<img src="{{ asset('magazine/img/e4.jpg') }}" alt="">
												</div>
												<div class="detail">
								...
								<div class="single-sidebar-widget most-popular-widget">
									...
									<div class="single-list flex-row d-flex">
										<div class="thumb">
											<img src="{{ asset('magazine/img/m1.jpg') }}" alt="">
										</div>
										<div class="details">
											<a href="image-post.html">
									...
									<div class="single-list flex-row d-flex">
										<div class="thumb">
											<img src="{{ asset('magazine/img/m2.jpg') }}" alt="">
										</div>
										<div class="details">
											<a href="image-post.html">
